...
Officer: 8243477
CaseNum: 403-0-22121106-8243477
...
- To sound the alarm, draw a Indigo rectangle covering the remainder of the map from Mullenweg Street to the east.
...
function draw()
{
    ...
    if(mouseX > 250){
      fill(75,0,130);
      rect(260, 0, img.width-260, img.height)
    }
