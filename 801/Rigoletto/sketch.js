...
Officer: 8243477
CaseNum: 801-0-32994774-8243477
...
- Do this by setting the selected  property of the element in viewers to true. 
- We know that one member of the order is seated in the 3rd row, 9th seat
- But you can identify the other 7 members of the order by their trademark bow tie. 
...
function draw()
{
	image(crowdImg, 0, 0);
	////////////YOUR CODE GOES HERE////////////////////////
	viewers[2][8].selected = true;
	viewers[3][1].selected = true;
	viewers[4][9].selected = true;
	viewers[5][1].selected = true;
	viewers[6][7].selected = true;
	viewers[7][5].selected = true;
	viewers[8][3].selected = true;
	viewers[8][6].selected = true;
