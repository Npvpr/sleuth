...
Officer: 8243477
CaseNum: 802-0-70622761-8243477
...
a company used by the shady politicians of Console City to make them seem more popular 
than they really are.

They’re prepared to give up the dirt on their techniques if we can beat them in a game
of 5 card stud poker. We can’t go in and gamble away Sleuth & Co’s cash reserves. 
...
- Inside the function, use a for loop to set the marked property of the playingCards 
  array elements to true when the suit is Diamonds or the value is 7
...
function pickCards(){
	for(let i = 0; i < playingCards.length; i++){
		if(playingCards[i].cardSuit == "Diamonds" || playingCards[i].value == "7"){
